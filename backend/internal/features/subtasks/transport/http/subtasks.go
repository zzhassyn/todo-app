...
type PatchSubtaskRequest struct {
	Title    core_http_types.Nullable[string] `json:"title" validate:"omitempty,min=1,max=100"`
	Position core_http_types.Nullable[int]    `json:"position" validate:"omitempty,min=0"`
}
